...
public class CustomerViewAllCarAdapter extends FirestoreRecyclerAdapter<Car, CustomerViewAllCarAdapter.ViewHolder> {

    private CustomerViewAllCarAdapter.OnItemClickListener listener;

    public CustomerViewAllCarAdapter(@NonNull FirestoreRecyclerOptions<Car> options) {
        super(options);
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull final CustomerViewAllCarAdapter.ViewHolder viewHolder, int i, @NonNull Car car) {
    ...
    @NonNull
    @Override
    public CustomerViewAllCarAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater
                .from(parent.getContext())
                .inflate(R.layout.car_item_view, parent, false);
        return new CustomerViewAllCarAdapter.ViewHolder(view);
    }

    public void setOnItemClickListener(CustomerViewAllCarAdapter.OnItemClickListener listener) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            carVinTextView.setVisibility(View.GONE);
